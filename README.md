...
|---|---|---|---|
| STOI | **0.818** | **0.8001** | > 0.80 |
| NISQA MOS | **1.654** | **2.779** | > 2.25 |
| Mean perplexity (8 квантизаторов) | **402.77** | **475.4** | - |
...
- GAN финальный: https://www.comet.com/german-zverev/soundstream/9x8wz76ek1nnfj4i7a6pdwcevzacu5yr
